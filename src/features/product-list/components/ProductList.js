...
import { check, fetchAProductByIdAsync, fetchAProductsByFilterAsync, fetchAProductsBySortAsync, fetchAllProductsAsync, fetchBrandsAsync, fetchCategoriesAsync, selectBrands, selectCategories, selectProducts } from "../productSlice";
import { fetchAllProducts, fetchCategories, fetchProductsByFilter } from "../productApi";
...
// Now, you can safely build the filters array using brands data


const brands = useSelector(selectBrands).brands;
const categories = useSelector(selectCategories).categories;
  ...
  const  handleFilter = (e,section,option) =>{
    ...
    dispatch(fetchAProductsByFilterAsync(newFilter));
  }
  const handleSorting = (e,option)=>{
    let newValue = {...filter,"_sort":option.sort,"_order":option.order};
    setFilter(newValue);
    dispatch(fetchAProductsByFilterAsync(newValue));
  }
  return (
    <div>
      <div>
        <div className="bg-white">
          <div>
            ...
            {/* product and filtering ends here */}
